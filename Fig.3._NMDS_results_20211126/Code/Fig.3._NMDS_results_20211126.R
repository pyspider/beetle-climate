...
OTU_NMDS_1400m_OTU_NMDS<- ggplot(OTU_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  labs(title = str_wrap(paste("OTU no phylogenetic information (1400m)",paste('Stress =', round(OTU_biweek.nmds2$stress, 4))), width=35)) + theme(legend.position = "none")

OTU_NMDS_1400m_OTU_NMDS


OTU_NMDS_1800m_OTU_NMDS <- ggplot(OTU_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = str_wrap(paste("OTU no phylogenetic information (1800m)",paste('Stress =', round(OTU_biweek.nmds2$stress, 4))), width=35))+
  theme(legend.position = "none")# +  coord_cartesian(xlim=c(-0.25,-0.175),ylim=c(0.125,0.2)) 

OTU_NMDS_1800m_OTU_NMDS

#####################################
#####################################
# Now let's plot different elevation separately for all seasons
# fig.S4
#####################################
#####################################
######Nov 26: ZX added

OTU.season.nmds.hul <- gg_ordiplot(OTU_biweek.nmds2, groups =OTU_NMDS$Season, show.groups = c("Spring","Autumn","Winter","Summer") , hull = TRUE, spiders = TRUE,label = TRUE, ellipse = FALSE, plot = FALSE,conf=0.95,kind = "se")

OTU.location.nmds.spider <- gg_ordiplot(OTU_biweek.nmds2, groups =OTU_NMDS$Location, hull = TRUE, spiders = TRUE,label = TRUE, ellipse = FALSE, plot = FALSE,conf=0.95,kind = "se")

my.colors <- c("#896a45","gray","gray","Steelblue","#1d953f","black")

OTU_NMDS_1400m_seasons<- ggplot(OTU_NMDS,aes(x=NMDS1, y=NMDS2))+
  geom_point(data = OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1400,],aes(color=Season,shape=Location_and_elevation), size =2)+
  scale_shape_manual(values=c(19,1,15,0,1,1))+
  scale_color_manual(values = alpha(my.colors,0.5))+ geom_segment(data=OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1400,])),][which(OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1400,])),]$Group=="North"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=1),alpha=0.4,show.legend=FALSE) +geom_segment(data=OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1400,])),][which(OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1400,])),]$Group=="South"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=2),alpha=0.4,show.legend=FALSE)+ scale_linetype_identity()+labs(x = paste("NMDS1"), y = paste("NMDS2")) +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
OTU_NMDS_1400m_seasons

OTU_NMDS_1800m_seasons <- ggplot(OTU_NMDS,aes(x=NMDS1, y=NMDS2))+
  geom_point(data = OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1800,],aes(color=Season,shape=Location), size =2)+
  scale_shape_manual(values=c(19,1,15,0))+
  scale_color_manual(values = alpha(my.colors,0.5))+ geom_segment(data=OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1800,])),][which(OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1800,])),]$Group=="North"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=1),alpha=0.4,show.legend=FALSE) +geom_segment(data=OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1800,])),][which(OTU.location.nmds.spider$df_spiders[which(rownames(OTU.location.nmds.spider$df_spiders) %in% rownames(OTU_NMDS[(OTU_NMDS$Season=="Spring"|OTU_NMDS$Season=="Autumn"|OTU_NMDS$Season=="Winter"|OTU_NMDS$Season=="Summer")&OTU_NMDS$elevation==1800,])),]$Group=="South"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=2),alpha=0.4,show.legend=FALSE)+ scale_linetype_identity()+ labs(x = paste("NMDS1"), y = paste("NMDS2")) +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
OTU_NMDS_1800m_seasons

##################
#Unifrac on de novo tree
##################
...
iqtree<-read.tree(file="Data/partitions_only_COI.txt.treefile")
...
Unifrac_NMDS_1400m <- ggplot(Unifrac_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = str_wrap(paste("Unifrac on denovo tree (1400m)",paste('Stress =', round(Unifrac_biweek.nmds2$stress, 4))), width=35)) + theme(legend.position = "none")
...
Unifrac_NMDS_1800m <- ggplot(Unifrac_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = str_wrap(paste("Unifrac on denovo tree (1800m)",paste('Stress =', round(Unifrac_biweek.nmds2$stress, 4))), width=35))+
  theme(legend.position = "none")

#####################################
# Now let's plot different elevation seperately for all seasons
#####################################

Unifrac.season.nmds.hul <- gg_ordiplot(Unifrac_biweek.nmds2, groups =Unifrac_NMDS$Season, show.groups = c("Spring","Autumn","Winter","Summer") , hull = TRUE, spiders = TRUE,label = TRUE, ellipse = FALSE, plot = FALSE,conf=0.95,kind = "se")

Unifrac.location.nmds.spider <- gg_ordiplot(Unifrac_biweek.nmds2, groups =Unifrac_NMDS$Location, hull = TRUE, spiders = TRUE,label = TRUE, ellipse = FALSE, plot = FALSE,conf=0.95,kind = "se")

my.colors <- c("#896a45","gray","gray","Steelblue","#1d953f","black")

Unifrac_NMDS_1400m_seasons<- ggplot(Unifrac_NMDS,aes(x=NMDS1, y=NMDS2))+
  geom_point(data = Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1400,],aes(color=Season,shape=Location_and_elevation), size =2)+
  scale_shape_manual(values=c(19,1,15,0,1,1))+
  scale_color_manual(values = alpha(my.colors,0.5))+ geom_segment(data=Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1400,])),][which(Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1400,])),]$Group=="North"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=1),alpha=0.4,show.legend=FALSE) +geom_segment(data=Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1400,])),][which(Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1400,])),]$Group=="South"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=2),alpha=0.4,show.legend=FALSE)+ scale_linetype_identity()+labs(x = paste("NMDS1"), y = paste("NMDS2")) +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = str_wrap(paste("Unifrac on single-gene tree (1400m)",paste('Stress =', round(Unifrac_biweek.nmds2$stress, 4))), width=35)) + theme(legend.position = "none")
Unifrac_NMDS_1400m_seasons


Unifrac_NMDS_1800m_seasons <- ggplot(Unifrac_NMDS,aes(x=NMDS1, y=NMDS2))+
  geom_point(data = Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1800,],aes(color=Season,shape=Location), size =2)+
  scale_shape_manual(values=c(19,1,15,0))+
  scale_color_manual(values = alpha(my.colors,0.5))+ geom_segment(data=Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1800,])),][which(Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1800,])),]$Group=="North"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=1),alpha=0.4,show.legend=FALSE) +geom_segment(data=Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1800,])),][which(Unifrac.location.nmds.spider$df_spiders[which(rownames(Unifrac.location.nmds.spider$df_spiders) %in% rownames(Unifrac_NMDS[(Unifrac_NMDS$Season=="Spring"|Unifrac_NMDS$Season=="Autumn"|Unifrac_NMDS$Season=="Winter"|Unifrac_NMDS$Season=="Summer")&Unifrac_NMDS$elevation==1800,])),]$Group=="South"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=2),alpha=0.4,show.legend=FALSE)+ scale_linetype_identity()+ labs(x = paste("NMDS1"), y = paste("NMDS2")) +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = str_wrap(paste("Unifrac on single-gene tree (1800m)",paste('Stress =', round(Unifrac_biweek.nmds2$stress, 4))), width=35))+
  theme(legend.position = "none")# +  coord_cartesian(xlim=c(-0.25,-0.175),ylim=c(0.125,0.2)) 
Unifrac_NMDS_1800m_seasons

##################
#Unifrac on placement tree
##################
...
placement_tree<-read.tree(file="Data/queries_10524_whole_13995_mitoalignment_V3_RAPPAS_Reduced_no_heur.newick")
...
Placement_NMDS_1400m <- ggplot(Placement_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = str_wrap(paste("Unifrac on mitogenome tree (1400m)",paste('Stress =', round(EPA_no_heur_whole_biweek.nmds2$stress, 4))), width=35)) + theme(legend.position = "none")
...
Placement_NMDS_1800m <- ggplot(Placement_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = str_wrap(paste("Unifrac on mitogenome tree (1800m)",paste('Stress =', round(EPA_no_heur_whole_biweek.nmds2$stress, 4))), width=35))+
  theme(legend.position = "none")
...
Placement.season.nmds.hul <- gg_ordiplot(EPA_no_heur_whole_biweek.nmds2, groups =Placement_NMDS$Season, show.groups = c("Spring","Autumn","Winter","Summer") , hull = TRUE, spiders = TRUE,label = TRUE, ellipse = FALSE, plot = FALSE,conf=0.95,kind = "se")

Placement.location.nmds.spider <- gg_ordiplot(EPA_no_heur_whole_biweek.nmds2, groups =Placement_NMDS$Location, hull = TRUE, spiders = TRUE,label = TRUE, ellipse = FALSE, plot = FALSE,conf=0.95,kind = "se")

my.colors <- c("#896a45","gray","gray","Steelblue","#1d953f","black")

Placement_NMDS_1400m_seasons<- ggplot(Placement_NMDS,aes(x=NMDS1, y=NMDS2))+
  geom_point(data = Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1400,],aes(color=Season,shape=Location_and_elevation), size =2)+
  scale_shape_manual(values=c(19,1,15,0,1,1))+
  scale_color_manual(values = alpha(my.colors,0.5))+ geom_segment(data=Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1400,])),][which(Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1400,])),]$Group=="North"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=1),alpha=0.4,show.legend=FALSE) +geom_segment(data=Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1400,])),][which(Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1400,])),]$Group=="South"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=2),alpha=0.4,show.legend=FALSE)+ scale_linetype_identity()+labs(x = paste("NMDS1"), y = paste("NMDS2")) +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
Placement_NMDS_1800m_seasons <- ggplot(Placement_NMDS,aes(x=NMDS1, y=NMDS2))+
  geom_point(data = Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1800,],aes(color=Season,shape=Location), size =2)+
  scale_shape_manual(values=c(19,1,15,0))+
  scale_color_manual(values = alpha(my.colors,0.5))+ geom_segment(data=Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1800,])),][which(Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1800,])),]$Group=="North"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=1),alpha=0.4,show.legend=FALSE) +geom_segment(data=Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1800,])),][which(Placement.location.nmds.spider$df_spiders[which(rownames(Placement.location.nmds.spider$df_spiders) %in% rownames(Placement_NMDS[(Placement_NMDS$Season=="Spring"|Placement_NMDS$Season=="Autumn"|Placement_NMDS$Season=="Winter"|Placement_NMDS$Season=="Summer")&Placement_NMDS$elevation==1800,])),]$Group=="South"),], aes(x=cntr.x, xend=x, y=cntr.y, yend=y,color=Group,linetype=2),alpha=0.4,show.legend=FALSE)+ scale_linetype_identity()+ labs(x = paste("NMDS1"), y = paste("NMDS2")) +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
dev.new()
ggdraw() + draw_plot(OTU_NMDS_1400m_OTU_NMDS, x = 0, y = .66, width = 0.5, height = .33) +
  draw_plot(Unifrac_NMDS_1400m, x = 0, y = .33, width = 0.5, height = .33) +
  draw_plot(Placement_NMDS_1400m, x = 0, y = .0, width = 0.5, height = .33)+
  draw_plot(OTU_NMDS_1800m_OTU_NMDS, x = 0.5, y = .66, width = 0.5, height = .33) +
  draw_plot(Unifrac_NMDS_1800m, x = 0.5, y = .33, width = 0.5, height = .33) +
  draw_plot(Placement_NMDS_1800m, x = 0.5, y = .0, width = 0.5, height = .33)
ggsave("fig3_NMDS_non_ultrametric_20211226.pdf", width = 22, height = 20, units = "cm")
dev.off()

dev.new()
ggdraw() + draw_plot(OTU_NMDS_1400m_seasons, x = 0, y = .66, width = 0.5, height = .33) +
...
ggsave("figS4_NMDS_non_ultrametric_20211226.pdf", width = 22, height = 20, units = "cm")
dev.off()
