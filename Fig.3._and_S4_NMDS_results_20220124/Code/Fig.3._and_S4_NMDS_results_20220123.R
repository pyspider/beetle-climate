...
OTU_NMDS_1400m_OTU_NMDS<- ggplot(OTU_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  labs(title = paste("OTU no phylogenetic information (1400m)"))+annotate("text",x=-1,y=-1.2,label=paste('Stress =', round(OTU_biweek.nmds2$stress, 4)),size=3) + theme(legend.position = "none")
...
OTU_NMDS_1800m_OTU_NMDS <- ggplot(OTU_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = paste("OTU no phylogenetic information (1800m)"))+annotate("text",x=-1.15,y=-1.6,label=paste('Stress =', round(OTU_biweek.nmds2$stress, 4)),size=3) +
...
OTU_NMDS_1800m_seasons <- ggplot(OTU_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = paste("OTU no phylogenetic information (1800m)"))+annotate("text",x=-1.5,y=-1.6,label=paste('Stress =', round(OTU_biweek.nmds2$stress, 4)),size=3) +
  theme(legend.position = "none")# +  coord_cartesian(xlim=c(-0.25,-0.175),ylim=c(0.125,0.2)) 
...
Unifrac_NMDS_1400m <- ggplot(Unifrac_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = paste("Unifrac on denovo tree (1400m)")) +annotate("text",x=-0.28,y=-0.39,label=paste('Stress =', round(Unifrac_biweek.nmds2$stress, 4)),size=3) + theme(legend.position = "none")
...
Unifrac_NMDS_1800m <- ggplot(Unifrac_NMDS,aes(x=NMDS1, y=NMDS2))+
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        panel.border = element_blank(),
        panel.background = element_blank())+
  labs(title = paste("Unifrac on denovo tree (1800m)")) +annotate("text",x=-0.26,y=-0.39,label=paste('Stress =', round(Unifrac_biweek.nmds2$stress, 4)),size=3)+
...
ggsave("fig3_NMDS_non_ultrametric_20220124.pdf", width = 22, height = 20, units = "cm")
dev.off()
