...
save(otu.abun,file="pd.otu_20211214")
...
save(pd.abun,file="pd.abun_denovo_treepl_20211125")
...
p.denovo <- p0.denovo+p1.denovo+p2.denovo
...
p.mito <- p0.mito+p1.mito+p2.mito
p.mito

dev.new()
pdf("Fig.4._Abundance-based_inext3d_20211215.pdf",width=14,height=18)
p.otu/p.denovo/p.mito
dev.off()
