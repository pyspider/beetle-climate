...
otu.abun.whole <- iNEXT3D(loss.abun.data, diversity = 'TD', q = c(0,1,2), datatype = "abundance")
save(otu.abun.whole,file="pd.otu_whole_20211220")
...
save(pd.abun,file="pd.abun_denovo_treepl_whole_pd_20211219")
...
p.otu.whole <- (p0.otu.whole+labs(x="Number of individuals", y="Species Diversity",title = "Species richness\n")+
             theme(axis.line = element_line(colour = "black"),
                   panel.grid.major = element_blank(),
                   panel.grid.minor = element_blank(),
                   panel.border = element_blank(),
                   panel.background = element_blank())+theme(plot.title = element_text(size=16)))+(p1.otu.whole+scale_y_continuous(limits = c(0,1300))+labs(x="Number of individuals", y="Species Diversity",title = "Shannon diversity\n")+
                                                                                                     theme(axis.line = element_line(colour = "black"),
                                                                                                           panel.grid.major = element_blank(),
                                                                                                           panel.grid.minor = element_blank(),
                                                                                                           panel.border = element_blank(),
                                                                                                           panel.background = element_blank()))+theme(plot.title = element_text(size=16))+(p2.otu.whole+scale_y_continuous(limits = c(0,1300))+labs(x="Number of individuals", y="Species Diversity",title = "Simpson diversity\n"))+
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
load("Data/pd.abun_denovo_treepl_whole_pd_20211219")
...
p.denovo.whole <- (p0.denovo.whole+labs(x="Number of individuals", y="Phylogenetic Diversity",title = "Faith’s PD\nReference time = 307.87 Ma")+
               theme(axis.line = element_line(colour = "black"),
                     panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(),
                     panel.border = element_blank(),
                     panel.background = element_blank())+theme(plot.title = element_text(size=16)))+(p1.denovo.whole+scale_y_continuous(limits = c(307,419))+labs(x="Number of individuals", y="Phylogenetic Diversity",title = "Phylogenetic entropy\nReference time = 307.87 Ma")+
                                                                                                       theme(axis.line = element_line(colour = "black"),
                                                                                                             panel.grid.major = element_blank(),
                                                                                                             panel.grid.minor = element_blank(),
                                                                                                             panel.border = element_blank(),
                                                                                                             panel.background = element_blank())+theme(plot.title = element_text(size=16)))+(p2.denovo.whole+scale_y_continuous(limits = c(307,419))+labs(x="Number of individuals", y="Phylogenetic Diversity",title = "Rao’s quadratic entropy\nReference time = 307.87 Ma")+
                                                                                                                                                                                               theme(axis.line = element_line(colour = "black"),
                                                                                                                                                                                                     panel.grid.major = element_blank(),
                                                                                                                                                                                                     panel.grid.minor = element_blank(),
                                                                                                                                                                                                     panel.border = element_blank(),
...
load("Data/pd.abun_mito_whole_pd_20211219")
...
p2.mito.whole<-ggplot(filter(pd.abun.mito.whole,pd.abun.mito.whole$Method!="Extrapolation"), aes(x=m, y=qPD, colour=Assemblage))  +
  ...
  theme(legend.position = "bottom", 
        legend.title=element_blank(),
        text=element_text(size=18),
        legend.box = "vertical")+scale_shape_manual(name="Legend",values=c(1,19,0,0,1,19,2,10,13,7,12),breaks = c("North Summer Loss","South Summer Loss","Summer Loss","Winter Loss","North Winter Loss","South Winter Loss","Whole Dataset","1400 Loss","1800 Loss","South Loss","North Loss"),labels = c("– Summer_North","– Summer_South","– Summer","– Winter","– Winter_North","– Winter_South","    Whole dataset","– 1400 m","– 1800 m","– South","– North"))+scale_colour_manual(name="Legend",values = alpha(cols,0.5), aesthetics = c("colour", "fill"),breaks = c("North Summer Loss","South Summer Loss","Summer Loss","Winter Loss","North Winter Loss","South Winter Loss","Whole Dataset","1400 Loss","1800 Loss","South Loss","North Loss"),labels = c("– Summer_North","– Summer_South","– Summer","– Winter","– Winter_North","– Winter_South","    Whole dataset","– 1400 m","– 1800 m","– South","– North"))+theme(plot.title = element_text(hjust = 0.5))+theme_bw()+scale_linetype_discrete(name="",breaks=c("1","2"),labels=c("Rarefaction","Extrapolation"))

p.mito.whole <- (p0.mito.whole+labs(x="Number of individuals", y="Phylogenetic Diversity",title = "Faith’s PD\nReference time = 383.99 Ma")+
             theme(axis.line = element_line(colour = "black"),
                   panel.grid.major = element_blank(),
                   panel.grid.minor = element_blank(),
                   panel.border = element_blank(),
                   panel.background = element_blank())+theme(plot.title = element_text(size=16)))+(p1.mito.whole+scale_y_continuous(limits = c(383,5000))+labs(x="Number of individuals", y="Phylogenetic Diversity",title = "Phylogenetic entropy\nReference time = 383.99 Ma")+
                                                                                                     theme(axis.line = element_line(colour = "black"),
                                                                                                           panel.grid.major = element_blank(),
                                                                                                           panel.grid.minor = element_blank(),
                                                                                                           panel.border = element_blank(),
                                                                                                           panel.background = element_blank()))+theme(plot.title = element_text(size=16))+(p2.mito.whole+scale_y_continuous(limits = c(383,5000))+labs(x="Number of individuals", y="Phylogenetic Diversity",title = "Rao’s quadratic entropy\nReference time = 383.99 Ma"))+
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
dev.new()
pdf("Fig.S3._Abundance-based_inext3d_uisng_all_seasons_20211220.pdf",width=17,height=16)
