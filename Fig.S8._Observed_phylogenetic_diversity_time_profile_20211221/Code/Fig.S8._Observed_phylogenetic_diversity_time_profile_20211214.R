...
obs3d.abun <-obs3D(unifrac.abun.loss.set, diversity = 'PD', PDtree = iqtree.treepl, datatype = "abundance", q = c(0, 1, 2),PDtype = 'PD',PDreftime = seq(0.1, get.rooted.tree.height(iqtree.treepl), 1))
save(obs3d.abun,file="obs3d.abun_denovo_treepl_pd_20211219")
...
# Hill numbers (q):  0 = sp richness, 1 = Shannon, 2 = inverse Simpson
obs3d.abun <-obs3D(mito.abun.loss.set, diversity = 'PD', PDtree = mito.treepl, PDtype = 'PD', datatype = "abundance", q = c(0, 1, 2),PDreftime = seq(0.1, get.rooted.tree.height(mito.treepl), 1))
save(obs3d.abun,file="obs3d.abun_mito_pd_20211219") 

####################
#plot Observed phylogenetic diversity time profile
####################

load("Data/obs3d.abun_denovo_treepl_pd_20211219")
...
#p1.denovo+scale_x_continuous(limits = c(0,5))
...
pd.denovo<-(p0.denovo+labs(x="Time", y="Phylogenetic Diversity",title = "Faith’s PD\nReference time = 307.87 Ma")+
    theme(axis.line = element_line(colour = "black"),
          panel.grid.major = element_blank(),
          panel.grid.minor = element_blank(),
          panel.border = element_blank(),
          panel.background = element_blank())+theme(plot.title = element_text(size=16))+theme(legend.position = "none"))+(p1.denovo+scale_y_continuous(limits = c(0,1000))+labs(x="Time", y="Phylogenetic Diversity",title = "Phylogenetic entropy\nReference time = 307.87 Ma")+
                                                                                                                            theme(axis.line = element_line(colour = "black"),
                                                                                                                                  panel.grid.major = element_blank(),
                                                                                                                                  panel.grid.minor = element_blank(),
                                                                                                                                  panel.border = element_blank(),
                                                                                                                                  panel.background = element_blank())+theme(plot.title = element_text(size=16))+theme(legend.position = "none"))+(p2.denovo+scale_y_continuous(limits = c(0,1000))+labs(x="Time", y="Phylogenetic Diversity",title = "Rao’s quadratic entropy\nReference time = 307.87 Ma"))+
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
load("Data/obs3d.abun_mito_pd_20211219")
df.point <- obs3d.abun[which(obs3d.abun$Order.q=="0"),]
df.point <- df.point[which(df.point$Reftime==max(df.point$Reftime)),]
df.line <- obs3d.abun[which(obs3d.abun$Order.q=="0"),]
...
#p0.mito+scale_x_continuous(limits = c(0,5))+scale_y_continuous(limits = c(0,4000))
...
pd.mito<-(p0.mito+labs(x="Time", y="Phylogenetic Diversity",title = "Faith’s PD\nReference time = 383.99 Ma")+
              theme(axis.line = element_line(colour = "black"),
                    panel.grid.major = element_blank(),
                    panel.grid.minor = element_blank(),
                    panel.border = element_blank(),
                    panel.background = element_blank())+theme(plot.title = element_text(size=16))+theme(legend.position = "none"))+(p1.mito+scale_y_continuous(limits = c(0,7000))+labs(x="Time", y="Phylogenetic Diversity",title = "Phylogenetic entropy\nReference time = 383.99 Ma")+
                                                                                                                                      theme(axis.line = element_line(colour = "black"),
                                                                                                                                            panel.grid.major = element_blank(),
                                                                                                                                            panel.grid.minor = element_blank(),
                                                                                                                                            panel.border = element_blank(),
                                                                                                                                            panel.background = element_blank())+theme(plot.title = element_text(size=16))+theme(legend.position = "none")+geom_vline(xintercept=65.5,color="black",linetype=c(2)))+(p2.mito+scale_y_continuous(limits = c(0,7000))+labs(x="Time", y="Phylogenetic Diversity",title = "Rao’s quadratic entropy\nReference time = 383.99 Ma")+
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
        panel.background = element_blank())+theme(plot.title = element_text(size=16))+geom_vline(xintercept=65.5,color="black",linetype=c(2)))
pd.mito

pdf("Fig.S8_Observed_phylogenetic_diversity_time_profile_20211220.pdf",width=17,height=10.7)
pd.denovo/pd.mito
dev.off()
